/*
 * FROM https://github.com/sailormoon/flags/pull/11
 * There is a bug when parsing empty tokens that causes a crash.
 * Since we support files with no extension, I fixed the bug locally
 * and will submit a PR at some point.
 */
